...
var submitWordBtn = document.querySelector(".submit-btn");
submitWordBtn.addEventListener("click", /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
  var commaSeparatedWords, gridSize, result, grid, wordListSection, wordListNode;
    ...
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return fetch("./wordgrid?gridSize=".concat(gridSize, "&wordsList=").concat(commaSeparatedWords));
...
//# sourceMappingURL=/js.0ccf8614.js.map